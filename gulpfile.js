...
// Paket för livereload - ladda om sidan under utveckling
...
function watchTask() {
    watch([files.htmlPath, files.sassPath, files.cssPath, files.jsPath],
         parallel(copyHTML, sassTask, cssTask, jsTask));
}
